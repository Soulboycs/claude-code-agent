    ...
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in">
      <div className="bg-[#181920] border border-[#2c2d38] rounded-xl w-full max-w-lg shadow-2xl overflow-hidden flex flex-col">
        ...
        <div className="p-5 space-y-4 text-xs max-h-[60vh] overflow-y-auto">
          {/* OpenAI API Key */}
          <div>
            <label className="block text-neutral-400 font-medium mb-1">OpenAI API Key (also for DeepSeek/Compatible)</label>
            <input
              type="password"
              value={config.apiKey || ''}
          ...
          {/* Anthropic API Key */}
          <div>
            <label className="block text-neutral-400 font-medium mb-1">Anthropic API Key</label>
            <input
              type="password"
          ...
          {/* Gemini API Key */}
          <div>
            <label className="block text-neutral-400 font-medium mb-1">Google Gemini API Key</label>
            <input
              type="password"
          ...
          <hr className="border-[#2b2c38]" />

          {/* Base URL */}
          <div>
            <label className="block text-neutral-400 font-medium mb-1">OpenAI Compatible Base URL</label>
            <input
              type="text"
          ...
          {/* Ollama Base URL */}
          <div>
            <label className="block text-neutral-400 font-medium mb-1">Ollama Base URL</label>
            <input
              type="text"
